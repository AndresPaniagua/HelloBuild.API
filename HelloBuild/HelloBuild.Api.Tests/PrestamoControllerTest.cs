...
namespace HelloBuild.Api.Tests
{
    ...
    public class PrestamoControllerTest : IntegrationTestBuilder
    {
        ...
        public void GetPrestamoExito()
        {
            ...
            var carga = TestClient.PostAsync("/api/prestamo", solicitudPrestamo, new JsonMediaTypeFormatter()).Result;
            ...
            var c = TestClient.GetAsync($"api/prestamo/{idPrestamo}").Result;
        ...
        public void GetPrestamoError()
        {
            ...
            try
            {
                respuesta = TestClient.GetAsync($"api/prestamo/{prestamoId}").Result;
        ...
        public void PostPrestamoError()
        {
            ...
            try
            {
                ...
                respuesta = TestClient.PostAsync("api/prestamo", solicitudPrestamo, new JsonMediaTypeFormatter()).Result;
                respuesta.EnsureSuccessStatusCode();
        ...
        public void PostPrestamoInvitadoFechaEntregaExito()
        {
            ...
            var respuesta = TestClient.PostAsync("api/prestamo", solicitudPrestamo, new JsonMediaTypeFormatter()).Result;
            respuesta.EnsureSuccessStatusCode();
